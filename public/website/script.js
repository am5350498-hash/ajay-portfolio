...
if (typingElement) {
    ...
    // Database मधून data-position घ्या
    const positionData = typingElement.dataset.position;

    // जर database मध्ये position असेल तर ते वापरेल
    // उदा. data-position="Creative Developer,UI/UX Designer,Problem Solver"
    const phrases = positionData
        ? positionData.split(',').map(phrase => phrase.trim()).filter(phrase => phrase !== '')
        : ['Creative Developer', 'UI/UX Designer', 'Problem Solver', 'Digital Creator'];
    ...
    function typeText() {
        ...
        if (!isDeleting) {
            ...
            // पूर्ण text झाल्यावर 2 sec थांबा
            ...
            // पूर्ण delete झाल्यावर next phrase
            if (charIndex === 0) {
